  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uBlendAngle:     { value: 25.0 },
        uBlendSoftness:  { value: 0.12 },
        uRotationAmount: { value: 320.0 },
        ...
        uCenterOffset:   { value: new Float32Array([0, 0.05]) },
        uZoom:           { value: 1.05 },
        uColor1:         { value: new Float32Array(hexToRgb('#7a2630')) },
        uColor2:         { value: new Float32Array(hexToRgb('#ff2727')) },
        uColor3:         { value: new Float32Array(hexToRgb('#050506')) }
      }
    });
